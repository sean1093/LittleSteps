...
One entry point at `/#/` lists four services. They share a design system, an
...
- **幼兒百科** — 44 articles on toilet training, language, emotions, fussy eating and illness
...
**Tooling** — Vitest + Testing Library (531 tests), ESLint, Husky pre-commit,
...
regenerated by `scripts/buildNursingRooms.cjs`. It is excluded from the PWA
