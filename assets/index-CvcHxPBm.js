 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,H){var F=P.length;P.push(H);e:for(;0<F;){var q=F-1>>>1,_=P[q];if(0<r(_,H))P[q]=H,P[F]=_,F=q;else break e}}function n(P){return P.length===0?null:P[0]}function a(P){if(P.length===0)return null;var H=P[0],F=P.pop();if(F!==H){P[0]=F;e:for(var q=0,_=P.length,sn=_>>>1;q<sn;){var at=2*(q+1)-1,B1=P[at],ze=at+1,cn=P[ze];if(0>r(B1,F))ze<_&&0>r(cn,B1)?(P[q]=cn,P[ze]=F,q=ze):(P[q]=B1,P[at]=F,q=at);else if(ze<_&&0>r(cn,F))P[q]=cn,P[ze]=F,q=ze;else break e}}return H}function r(P,H){var F=P.sortIndex-H.sortIndex;return F!==0?F:P.id-H.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var s=Date,l=s.now();e.unstable_now=function(){return s.now()-l}}var d=[],h=[],u=1,y=null,k=3,m=!1,v=!1,M=!1,j=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(P){for(var H=n(h);H!==null;){if(H.callback===null)a(h);else if(H.startTime<=P)a(h),H.sortIndex=H.expirationTime,t(d,H);else break;H=n(h)}}function x(P){if(M=!1,p(P),!v)if(n(d)!==null)v=!0,Y(w);else{var H=n(h);H!==null&&Be(x,H.startTime-P)}}function w(P,H){v=!1,M&&(M=!1,g(S),S=-1),m=!0;var F=k;try{for(p(H),y=n(d);y!==null&&(!(y.expirationTime>H)||P&&!re());){var q=y.callback;if(typeof q=="function"){y.callback=null,k=y.priorityLevel;var _=q(y.expirationTime<=H);H=e.unstable_now(),typeof _=="function"?y.callback=_:y===n(d)&&a(d),p(H)}else a(d);y=n(d)}if(y!==null)var sn=!0;else{var at=n(h);at!==null&&Be(x,at.startTime-H),sn=!1}return sn}finally{y=null,k=F,m=!1}}var L=!1,b=null,S=-1,z=5,V=-1;function re(){return!(e.unstable_now()-V<z)}function le(){if(b!==null){var P=e.unstable_now();V=P;var H=!0;try{H=b(!0,P)}finally{H?ge():(L=!1,b=null)}}else L=!1}var ge;if(typeof f=="function")ge=function(){f(le)};else if(typeof MessageChannel<"u"){var oe=new MessageChannel,bt=oe.port2;oe.port1.onmessage=le,ge=function(){bt.postMessage(null)}}else ge=function(){j(le,0)};function Y(P){b=P,L||(L=!0,ge())}function Be(P,H){S=j(function(){P(e.unstable_now())},H)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){v||m||(v=!0,Y(w))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):z=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return k},e.unstable_getFirstCallbackNode=function(){return n(d)},e.unstable_next=function(P){switch(k){case 1:case 2:case 3:var H=3;break;default:H=k}var F=k;k=H;try{return P()}finally{k=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,H){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var F=k;k=P;try{return H()}finally{k=F}},e.unstable_scheduleCallback=function(P,H,F){var q=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?q+F:q):F=q,P){case 1:var _=-1;break;case 2:_=250;break;case 5:_=1073741823;break;case 4:_=1e4;break;default:_=5e3}return _=F+_,P={id:u++,callback:H,priorityLevel:P,startTime:F,expirationTime:_,sortIndex:-1},F>q?(P.sortIndex=F,t(h,P),n(d)===null&&P===n(h)&&(M?(g(S),S=-1):M=!0,Be(x,F-q))):(P.sortIndex=_,t(d,P),v||m||(v=!0,Y(w))),P},e.unstable_shouldYield=re,e.unstable_wrapCallback=function(P){var H=k;return function(){var F=k;k=H;try{return P.apply(this,arguments)}finally{k=F}}}})(YI);QI.exports=YI;var OA=QI.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $V=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),i=(e,t)=>{const n=C.forwardRef(({color:a="currentColor",size:r=24,strokeWidth:o=2,absoluteStrokeWidth:s,className:l="",children:d,...h},u)=>C.createElement("svg",{ref:u,...GV,width:r,height:r,stroke:a,strokeWidth:s?Number(o)*24/Number(r):o,className:["lucide",`lucide-${$V(e)}`,l].join(" "),...h},[...t.map(([y,k])=>C.createElement(y,k)),...Array.isArray(d)?d:[d]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.303.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
