    ...
    <div className="screen">
      ...
      <main className="screen-body space-y-6">
        ...
        <Section title="分享給家人，也收得回來">
          ...
          <P>
            有一件事想先說清楚：加入的家人和你有一樣的權限——可以記錄，也可以把其他人移除。我們沒有做主帳號和副帳號的階級，因為一起帶孩子的兩個大人，通常不需要誰管誰。唯一的限制是名單不能空掉：最後一位成員無法把自己移除，否則這份紀錄會變成沒有人進得去。
          </P>
        </Section>
        ...
        {/* 標題的順序就是段落的順序：先「帶得走」，再「刪得掉」。四段各講一件
            事，而摘要那一句要緊跟在整份匯出後面——它是同一個問題的次要答案，
            擺在前面會讓家長以為那三種摘要就是全部。 */}
        <Section title="隨時帶得走，也刪得掉">
          <P>整份紀錄可以一鍵匯出成檔案：在帳號視窗按下寶寶旁邊的匯出，檔案、所有日誌、成長紀錄與日記會一起存成一個檔案，那份是你的。</P>
          <P>看診摘要、週報與行事曆匯出是給特定場合的摘要版本，隨時也帶得走。</P>
          <P>刪掉一個孩子是一次刪完：檔案、所有日誌、成長紀錄與日記一起消失，不會留下半截。</P>
          <P>帳號本身也刪得掉，入口在同一個視窗：只有你一個人在用的孩子會整份消失，還有家人在用的則是把你從名單上移除、紀錄留給他們，最後連你的登入帳號一起消失。</P>
        </Section>
                ...
                <div className="pt-3">
                  <Plain
                    items={[
                      ...
                      '使用統計的每一個事件能帶哪些欄位，有測試釘死，多一個欄位就紅。',
                    ]}
                  />
                </div>
              </motion.div>
