        ...
        <>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="text-center">
              ...
              <div className="text-xl font-bold text-[#7EC8E3]">{summary.feedingCount}</div>
            ...
            <div className="text-center">
              <div className="text-2xl mb-1">💤</div>
              <div className="text-xl font-bold text-[#7EC8E3]">{summary.sleepCount}</div>
            ...
            <div className="text-center">
              <div className="text-2xl mb-1">💩</div>
              <div className="text-xl font-bold text-[#7EC8E3]">{summary.diaperCount}</div>
          ...
          <div className="pt-3 border-t border-gray-200">
            <button className="text-sm text-[#7EC8E3] hover:text-[#6BB8D3] font-medium transition-colors">
              查看詳細記錄 →
            </button>
          </div>
        </>
