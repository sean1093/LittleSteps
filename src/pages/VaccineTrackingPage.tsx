...
export default function VaccineTrackingPage({
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] pb-6 relative overflow-hidden">
      ...
      <div className="absolute top-10 right-5 w-48 h-48 bg-[#E8F5E9] rounded-full opacity-30 blur-3xl pointer-events-none" />
      <div className="absolute bottom-40 left-5 w-64 h-64 bg-[#E8F4F8] rounded-full opacity-30 blur-3xl pointer-events-none" />
