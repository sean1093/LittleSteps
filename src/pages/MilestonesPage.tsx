...
export default function MilestonesPage({ progress, onToggleMilestone, user, onSignIn }: MilestonesPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] pb-6 relative overflow-hidden">
      ...
      <div className="absolute top-10 right-5 w-48 h-48 bg-[#FFE5E5] rounded-full opacity-30 blur-3xl pointer-events-none" />
      <div className="absolute top-40 left-5 w-56 h-56 bg-[#E8F4F8] rounded-full opacity-30 blur-3xl pointer-events-none" />
